...
from lists.forms import ExistingListItemForm, ItemForm, DUPLICATE_ITEM_ERROR, EMPTY_LIST_ERROR
...
class ListViewTest(TestCase):
	...
	def test_POST_redirects_to_list_view_(self):
		other_list = List.objects.create()
		correct_list = List.objects.create()

		response = self.client.post('/lists/%d/' % (correct_list.id,), 
			data={'text': 'A new item for an existing lists'}
		)
